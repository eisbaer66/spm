...
public class CommandTests
{
    ...
    private static readonly string[] ExpectNoPlugins            = { "-: tf2attributes", "-: SM-TFCustAttr", "-: morecolors.inc" };
    ...
    private static readonly object[] Cases =
    {
        new object[]
        {
            ...
            new Dictionary<string, string[]?>
            {
                ...
                { "-: include/morecolors.inc", null },
                { "-: include/morecolors.inc.version", null },
                { "-: lib/morecolors_newsyntax.inc", null },
                { "-: lib/morecolors_newsyntax.inc.version", null },
            },
            new []
            {
        ...
        new object[]
        {
            ...
            new[]
            {
                "3 dependencies are currently installed",
                ...
                "StaticUrl:https://raw.githubusercontent.com/JoinedSenses/SourceMod-IncludeLibrary/master/include/morecolors.inc",
            },
        },
        new object[]
        {
        ...
        new object[]
        {
            ...
            new[]{"3 dependencies restored:", "dependency GitHubTagFile:nosoop/tf2attributes:tf2attributes.inc removed"},
        },
        new object[]
        {
            "filled spm",
            ...
            new[]{"3 dependencies restored:", "dependency GitHubTagZip:nosoop/SM-TFCustAttr:package.zip:scripting/include/tf_custom_attributes.inc removed"},
        },
        new object[]
        {
            "filled spm",
            "restore; remove StaticUrl:https://raw.githubusercontent.com/JoinedSenses/SourceMod-IncludeLibrary/master/include/morecolors.inc",
            new Dictionary<string, string[]?>
            {
                { "spm.json", ExpectBothPlugins },
                { "spm.local.json", null },
            ...
            new[]{"3 dependencies restored:", "dependency StaticUrl:https://raw.githubusercontent.com/JoinedSenses/SourceMod-IncludeLibrary/master/include/morecolors.inc removed"},
        },
        ...
        new object[]
        {
            ...
            new[]{"3 dependencies restored:", "2 dependencies updated:"},
        },
        ...
        {
            "no spm",
            "install static-url https://raw.githubusercontent.com/JoinedSenses/SourceMod-IncludeLibrary/master/include/morecolors.inc",
            new Dictionary<string, string[]?>
            {
                { "spm.json", new []{ "-: tf2attributes", "-: SM-TFCustAttr", "morecolors" } },
                { "spm.local.json", null },
                { "spm.lock.json", new []{ "-: tf2attributes", "-: SM-TFCustAttr", "morecolors" } },
                { "-: include/tf2attributes.inc", null },
                { "-: include/tf2attributes.inc.version", null },
                { "-: include/tf_custom_attributes.inc", null },
                { "-: include/tf_custom_attributes.inc.version", null },
            ...
            new[]{"dependency StaticUrl:https://raw.githubusercontent.com/JoinedSenses/SourceMod-IncludeLibrary/master/include/morecolors.inc installed version 1.0"},
        },
        new object[]
        {
            "no spm",
            "install static-url https://raw.githubusercontent.com/JoinedSenses/SourceMod-IncludeLibrary/master/include/morecolors.inc --download-path lib/morecolors_newsyntax.inc",
            new Dictionary<string, string[]?>
            {
                { "spm.json", new []{ "-: tf2attributes", "-: SM-TFCustAttr", "morecolors" } },
                { "spm.local.json", null },
    ...
    public async Task CommandsWritesFiles(string key, string command, IDictionary<string, string[]?> expectedFiles, IEnumerable<string> expectedOutputs)
    {
        ...
        //var folderName   = new string(command.Where(c => !invalidChars.Contains(c)).Select(c => c == '-' ? '_' : c).ToArray());
        var folderName = new string(Guid.NewGuid().ToString().Where(c => !invalidChars.Contains(c)).ToArray());
        ...
        {
            Console.WriteLine($"starting command: {cmd} in {wd}");
